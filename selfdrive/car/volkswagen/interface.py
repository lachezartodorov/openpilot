...
NON_LINEAR_TORQUE_PARAMS = {
  CAR.VOLKSWAGEN_JETTA_MK6: [19.999999999518543, 0.013752973175158755, 0.29000000000000004, -0.007255929913027823, \
...
class CarInterface(CarInterfaceBase):
  ...
  def _get_params(ret, candidate: CAR, fingerprint, car_fw, experimental_long, docs):
    ...
    if ret.flags & VolkswagenFlags.PQ or ret.flags & VolkswagenFlags.MLB:
      ...
      ret.lateralTuning.pid.kpV = [0.005, 0.01]
      ret.lateralTuning.pid.kiV = [0.002, 0.0015]
    else:
